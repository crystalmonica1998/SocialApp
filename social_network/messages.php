...
while($row_user = mysqli_fetch_array($run_user)){
	...
	<img class='img-circle' src='users/$user_image' height='90px' width='80px' title='$user_name'>
...
if(isset($_POST['send_msg'])){
	...
	if($msg == ""){
		echo "<h4 style='color:red; text-align:center;'>Please Enter a Message!</h4>";
	}
...
if(isset($_GET['u_id'])){
	...
	// put outside of php tag from here
	}
