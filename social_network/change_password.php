...
<div class = "col-sm-12">
<div class = "well">
<center><h1 style="color:white;"><strong>Social App</strong></h1></center>
</div>
</div>
</div>
...
<div class = "input-group">
<span class = "input-group-addon"><i class = "glyphicon glyphicon-lock"></i></span>
<input id="password" type="password" class="form-control" placeholder="Confirm Password" name="pass1" required>
</div><br>
...
if(isset($_POST['change'])){
	...
	if($pass == $pass1){
		if(strlen($pass)>=6 && strlen($pass)<=60){
			...
			echo "<script>alert('Your Password should be greater than six characters!')</script>";
		}
	}
	else{
