...
<pre>Answer the above question; we will be asking it in case you forgot your <br>password.</pre>
<br><br>
</form>
<?php 
if(isset($_POST['sub'])){
...
<tr align="center">
<td colspan="6">
<input type="submit" class="btn btn-default" name="update" style="width:250px; background-color:#0b7dda; color:white;" value="Update">
</td>
</tr>
</table>
</form>
...
if(isset($_POST['update'])){
	...
	$update = "update users set f_name='$f_name', l_name='$l_name', user_name='$u_name', describe_user='$describe_user', Relationship='$Relationship_status', user_pass='$u_pass', user_email='$u_email',
    user_country='$u_country', user_gender='$u_gender', user_birthday='$u_birthday' where user_id='$user_id'";
	$run = mysqli_query($con, $update);
		if($run){
			echo "<script>alert('your profile was successfully updated!')</script>";
		    echo "<script>window.open('edit_profile.php?u_id=$user_id', '_self')</script>";
		}
		else{
			echo "<script>alert('Error while Updating information')</script>";
